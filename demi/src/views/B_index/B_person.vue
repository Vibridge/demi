  ...
  <div class="right">
    <div class="person_main">
      <div class="task">
        ...
        <div class="task_list">
          <ol>
            <li v-for="status in task_status" :key="status.activeName" @click="handleTask(status.activeName)"><div><p>{{status.name}}</p><p>{{status.num}}</p></div></li>
          </ol>
        </div>
      </div>
      <div class="order">
        ...
        <div class="order_list">
          <ul>
            <li v-for="status in order_status" :key="status.activeName" @click="handleOrder(status.activeName)">
