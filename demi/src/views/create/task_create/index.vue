                    ...
                    <div class="basic_info">
                        ...
                        <el-form ref="form" :model="form" label-width="92px">
                            ...
                            <el-form-item label="适合行业：">
                                <el-cascader ref="label" :options="type_list" :show-all-levels="false" v-model="form.industry" :props="{ label:'name', value:'label_id',multiple: true,}" placeholder="请选择行业" @focus="handleType" @change="handleLabel"></el-cascader>
                            </el-form-item>
                            <el-form-item label="发布城市：">
                                <el-cascader :options="city_tree" v-model="form.city" :show-all-levels="false" :props="{ label:'city_name', value:'city_id'}" placeholder="请选择城市" @focus="handleCity"></el-cascader>
                            </el-form-item>
                        </el-form>
                        <div class="line"></div>
                    </div>
                            ...
                            <el-form-item label="产品视频：">
                                <div class="video">
                                    ...
                                    <el-upload
                                        ...
                                        <video id="video" class="avatar" :src="this.form.video_path" v-show="form.video_path !== ''" controls></video>
                                        <img src="../../../assets/img/my_videos@2x.png" v-show="form.video_path === ''" class="el-icon-plus avatar-uploader-icon">
