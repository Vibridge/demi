      ...
      <div class="right">
        <div class="right_wrap">
          ...
          <div style="align-self: flex-end;width: 30%">
            ...
            <div class="download"><span><img src="../../assets/img/Android@2x.png" alt=""></span><p>Android</p><span><img src="../../assets/img/download@2x.png"></span></div>
          </div>
        </div>
        <div class="text">
          <ul>
            <li><span>1/</span><p>为了使人才与优质企业互动更高效，得米为你提供相应的视频简历、视频面试、对口专业招聘专场等模式对个人用户进行人才筛选。</p></li>
            <li><span>2/</span><p>得米为企业和求职者精准对接，视频简历能让企业更立体了解求职者，视频面试可以突破时间和地域，使企业招人更高效。</p></li>
            <li><span>3/</span><p>得米特有任务广场系统供企业发布短需求工种，并配有人才评价系统、钱包结算系统等功能。能有效为企业降低用人、试错成本，拓宽市场渠道。</p></li>
          </ul>
        </div>
      </div>
    </div>
